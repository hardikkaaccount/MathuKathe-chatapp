...
exports.testMatthu = testMatthu;
const hasura_1 = require("../utils/hasura");
async function testMatthu() {
    ...
    try {
        ...
        const result = await (0, hasura_1.execute)(MATTHU_QUERY_MUTATION, { prompt, group_id: groupId });
...
//# sourceMappingURL=testMatthu.js.map